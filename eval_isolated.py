...
# ------------------------------------
# file: eval_isolated.py
# date: Wed June 10 10:34 2015
# author:
# Maarten Versteegh
# github.com/mwv
...
from util import verb_print, pretty_cm
...
if __name__ == '__main__':
    ...
    def parse_args():
        parser = argparse.ArgumentParser(
            prog='eval_isolated.py',
            formatter_class=argparse.RawDescriptionHelpFormatter,
            description='evaluate predictions for isolated calls')
    ...
    callset_gold = set(df_gold.call.unique())
    callset_pred = set(df_pred.call.unique())
    ...
    y_gold = np.array([label2ix[call] for call in df_gold.call])
    y_pred = np.array([label2ix[call] for call in df_pred.call])
